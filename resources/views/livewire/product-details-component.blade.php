            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        @if($product->sale_price > 0 && $sale_timer->status == 1 && $sale_timer->sale_date > Carbon\Carbon::now())
                ...
                <div class="widget mercado-widget widget-product">
                    ...
                    <div class="widget-content">
                        <ul class="products">
                            ...
                            @foreach ($products_popular as $p_popular)
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        <div class="thumbnnail">
                                            <a href="{{ route('product.details', ['slug' => $p_popular->slug]) }}"
                                                title="{{ $p_popular->name }}">
                                                <figure><img
                                                        src="{{ asset('assets/images/products') }}/{{ $p_popular->image }}"
                                                        alt="{{ $p_popular->name }}"></figure>
                                            </a>
                                        </div>
                                        <div class="product-info">
                                            <a href="{{ route('product.details', ['slug' => $p_popular->slug]) }}"
                                                class="product-name"><span>{{ $p_popular->name }}</span></a>
                                            <div class="wrap-price"><span
                                                    class="product-price">${{ $p_popular->regular_price }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="wrap-show-advance-info-box style-1 box-in-site">
                    ...
                    <div class="wrap-products">
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                            ...
                            @foreach ($products_related as $p_related)
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('product.details', ['slug' => $p_related->slug]) }}"
                                            title="{{ $p_related->name }}">
                                            <figure><img
                                                    src="{{ asset('assets/images/products') }}/{{ $p_related->image }}"
                                                    width="214" height="214" alt="{{ $p_related->name }}">
                                            </figure>
                                        </a>
                                    ...
                                    <div class="product-info">
                                        <a href="{{ route('product.details', ['slug' => $p_related->slug]) }}"
                                            class="product-name"><span>{{ $p_related->name }}</span></a>
                                        <div class="wrap-price"><span
                                                class="product-price">${{ $p_related->price }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
